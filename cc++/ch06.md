...
In *Starting C++* you learned `std::string` for storing and manipulating text.
...
::: {.tip}
**Tip:** For formatted output, `std::format` (Chapter 9 of *Starting C++*) is more flexible than `std::to_string`.
