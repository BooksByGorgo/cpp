...
- lectures are assumed to be 65 minutes
...
- chapters and the corresponding exercises at the end of the chapters in `..`
- study guide in `../study-guides`
...
```
**Read:** chapter N of *Gorgo C for C++ Programmers*. **Do:** exercises X, Y, Z.
```
...
- When a chapter spans multiple lectures (e.g. lecture 5+6 both cover chapter 8), pick the subset of exercises that test the specific topics scheduled for the next lecture
