...
Instead of passing a `char[]`, you pass the address of a `char *` variable (`char **`), and `scanf` allocates exactly enough memory and puts its address into the variable:
