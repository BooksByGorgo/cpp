...
std::format("{:-}", 42);          // "42"  (no sign on positives, `-` on negatives)
...
int main() {
    // std::format builds a std::string; std::println prints it with a newline
    std::string header = std::format("{:<10} {:>6} {:>9}", "Item", "Qty", "Price");
    std::println("{}", header);
    std::println("{:-^27}", "");
