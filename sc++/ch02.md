...
Programs need to store data — numbers, letters, true/false values — and variables are how you do it.
A variable gives a name to a piece of memory that holds a value of a specific type.
In this chapter, you will learn about the basic types C++ offers, how to declare and use variables, how to group data with structures, and how to protect values with `const`.
...
This is important and will come up again when we discuss pointers and containers.
